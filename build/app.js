...
angular.module('app.frmUtils').factory('FRM_Signature', [
    ...
    function ($location) {
        ...
        data.Signature = '2026.01.23_01.09 Framework - PAS';
...
angular.module('app.frmUtils').factory('Application_Service', [
    'BackEndService',
    'DTService',
...
angular.module('app.frmUtils').factory('Organization_Service', [
    'BackEndService',
    'DTService',
    function (BackEndService, DTService) {
        var service = {};
        ...
        service.Table = function (scope) {
            ...
            return DTService.GenerateDTInstance('XFRM_O', 'Name', 'asc', filterObject, 'Name', pageLength, afterRequestData, searchKeyword);
        };
...
angular.module('app.frmUtils').factory('SessionDetail_Service', [
    'BackEndService',
    'DTService',
    function (BackEndService, DTService) {
        var service = {};
...
angular.module('app.frmUtils').factory('Session_Service', [
    'BackEndService',
    'DTService',
    function (BackEndService, DTService) {
        var service = {};
        ...
        service.Table = function (scope) {
            ...
            return DTService.GenerateDTInstance('XFRM_S', 'IssueDate desc, UserName', 'asc', filterObject, 'UserName,Organization,Application', pageLength, afterRequestData, searchKeyword);
        };
...
angular.module('app.frmUtils').factory('User_Service', [
    'BackEndService',
    'DTService',
    function (BackEndService, DTService) {
        var service = {};
        ...
        service.Table = function (scope) {
            ...
            return DTService.GenerateDTInstance('XFRM_U', 'Name', 'asc', filterObject, 'Name', pageLength, afterRequestData, searchKeyword);
        };
...
angular.module('app.frm').controller('OrganizationCtrl', function ($rootScope, $scope, Utility_Frm, Organization_Service) {
    // Dummy data, just for "Table: paging and searching"
    $scope.dt = {};
    $scope.dt.pageLength = 20;
    $scope.searchKeyword = '';
...
angular.module('app.frm').controller('SessionCtrl', function ($rootScope, $scope, Utility_Frm, Session_Service) {
    // Dummy data, just for "Table: paging and searching"
    $scope.dt = {};
    $scope.dt.pageLength = 20;
    $scope.searchKeyword = '';
...
angular.module('app.frm').controller('WorkspaceCtrl', function ($rootScope, $scope, Utility_Frm, Workspace_Service) {
    // Dummy data, just for "Table: paging and searching"
    $scope.dt = {};
    $scope.dt.pageLength = 20;
    $scope.searchKeyword = '';
